...
class _Translations$networkInterfacesPage$ms extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Secara lalai, Xetel Share menggunakan semua antara muka rangkaian tersedia. Anda boleh memulaukan rangkaian yang tidak diingini. Anda perlu mula semula pelayan untuk mengenakan perubahan.';
  @override
...
class _Translations$webSharePage$ms extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Xetel Share menggunakan sijil yang ditandatangani sendiri. Anda perlu menerimanya di pelayar anda.';
  @override
...
class _Translations$aboutPage$ms extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    'Xetel Share adalah aplikasi percuma dan sumber terbuka yang membolehkan anda berkongsi fail dan mesej secara selamat dan terjamin dengan peranti berdekatan yang berada dalam rangkaian tempatan anda tanpa memerlukan sebarang sambungan internet.',
...
class _Translations$donationPage$ms extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Xetel Share adalah percuma, sumber terbuka dan tanpa iklan. Jika anda menyukai aplikasi ini, anda boleh menyokong pembangunannya dengan derma.';
  @override
...
class _Translations$tray$ms extends Translations$tray$en {
  ...
  @override
  String get close => 'Keluar Xetel Share';
  @override
...
class _Translations$settingsTab$general$ms extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Tunjukkan Xetel Share dalam menu konteks';
  @override
...
class _Translations$settingsTab$other$ms extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Sokong Xetel Share';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ms extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Xetel Share tidak dapat mencari peranti lain tanpa mempunyai kebenaran untuk mengimbas rangkaian tempatan. Sila berikan kebenaran ini dalam tetapan.';
  @override
...
class _Translations$dialogs$sendModeHelp$ms extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Penerima yang tidak mempunyai Xetel Share dipasang boleh memuat turun fail yang dipilih dengan membuka pautan dalam pelayar mereka.';
}
