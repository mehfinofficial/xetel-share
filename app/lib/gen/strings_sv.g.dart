...
class _Translations$networkInterfacesPage$sv extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Som standard använder Xetel Share alla tillgängliga nätverksgränssnitt. Du kan utesluta oönskade nätverk här. Starta om servern för att tillämpa ändringarna.';
  @override
...
class _Translations$receiveOptionsPage$sv extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Xetel Share-mappen)';
  @override
...
class _Translations$webSharePage$sv extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Xetel Share använder ett självsignerat certifikat. Du måste godkänna det i webbläsaren.';
  @override
...
class _Translations$aboutPage$sv extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Om Xetel Share';
  @override
  List<String> get description => [
    'Xetel Share är en fri app med öppen källkod som gör det möjligt att säkert dela filer och meddelanden med enheter i närheten via det lokala nätverket, utan internetanslutning.',
...
class _Translations$donationPage$sv extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Xetel Share är en fri app med öppen källkod och utan annonser. Om du gillar appen kan du stödja utvecklingen genom att donera.';
  @override
...
class _Translations$tray$sv extends Translations$tray$en {
  ...
  @override
  String get close => 'Avsluta Xetel Share';
  @override
...
class _Translations$settingsTab$general$sv extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Visa Xetel Share i snabbmenyn';
  @override
...
class _Translations$settingsTab$other$sv extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Stöd Xetel Share';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$sv extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Xetel Share kan inte hitta andra enheter utan behörighet att söka i det lokala nätverket. Bevilja behörigheten i inställningarna.';
  @override
...
class _Translations$dialogs$sendModeHelp$sv extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Mottagare som inte har Xetel Share installerat kan ladda ner de valda filerna genom att öppna länken i sin webbläsare.';
}
