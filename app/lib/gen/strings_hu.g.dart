...
class _Translations$networkInterfacesPage$hu extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Alapértelmezésként a Xetel Share az összes rendelkezésre álló hálózati interfészt használja. Itt kizárhatja a nem kívánt hálózatokat. A módosítások alkalmazásához újra kell indítania a kiszolgálót.';
  @override
...
class _Translations$receiveOptionsPage$hu extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Xetel Share mappa)';
  @override
...
class _Translations$webSharePage$hu extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'A Xetel Share a saját aláírt tanúsítványt használja. A böngészőben kell elfogadnod.';
  @override
...
class _Translations$aboutPage$hu extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'A Xetel Share';
  @override
  List<String> get description => [
    'A Xetel Share egy ingyenes, nyílt forráskódú alkalmazás, amely lehetővé teszi a fájlok és üzenetek biztonságos megosztását a közeli eszközökkel a helyi hálózaton keresztül, internet kapcsolat nélkül.',
...
class _Translations$donationPage$hu extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'A Xetel Share ingyenes, nyílt forráskódú és hirdetések nélküli. Ha megtetszett az alkalmazás, adományával támogathatja a fejlesztést.';
  @override
...
class _Translations$settingsTab$general$hu extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'A Xetel Share megjelenítése a helyi menüben';
  @override
...
class _Translations$settingsTab$other$hu extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Xetel Share támogatás';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$hu extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'A Xetel Share nem találhat más eszközöket a helyi hálózat vizsgálatára vonatkozó engedély nélkül. Adja meg ezt az engedélyt a beállításokban.';
  @override
...
class _Translations$dialogs$sendModeHelp$hu extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Azok a címzettek, akiknél nincs telepítve a Xetel Share, letölthetik a kiválasztott fájlokat a hivatkozás megnyitásával a böngészőjükben.';
}
