...
class _Translations$networkInterfacesPage$it extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Per impostazione predefinita, Xetel Share utilizza tutte le interfacce di rete disponibili. È possibile escludere le reti indesiderate. È necessario riavviare il server per applicare le modifiche.';
  @override
...
class _Translations$receiveOptionsPage$it extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(cartella Xetel Share)';
  @override
...
class _Translations$webSharePage$it extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Xetel Share utilizza un certificato autofirmato. Devi accettarlo nel browser.';
  @override
...
class _Translations$aboutPage$it extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Informazioni su Xetel Share';
  @override
  List<String> get description => [
    'Xetel Share è un\'app gratuita e open-source che consente di condividere file e messaggi in modo sicuro con dispositivi vicini sulla tua rete locale, senza bisogno di una connessione internet.',
...
class _Translations$donationPage$it extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Xetel Share è gratuito, open-source e privo di pubblicità. Se ti piace l\'applicazione, puoi supportarne lo sviluppo con una donazione.';
  @override
...
class _Translations$tray$it extends Translations$tray$en {
  ...
  @override
  String get close => 'Esci da Xetel Share';
  @override
...
class _Translations$settingsTab$general$it extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostra Xetel Share nel menù contestuale';
  @override
...
class _Translations$settingsTab$other$it extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Supporta Xetel Share';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$it extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Xetel Share non può trovare altri dispositivi senza il permesso per la scansione della rete locale. Puoi concedere questo permesso nelle impostazioni.';
  @override
...
class _Translations$dialogs$sendModeHelp$it extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'I destinatari che non hanno installato Xetel Share possono scaricare i file selezionati aprendo il link nel loro browser.';
}
