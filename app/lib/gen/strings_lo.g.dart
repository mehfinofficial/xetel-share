...
class _Translations$networkInterfacesPage$lo extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'ໂດຍຄ່າເລີ່ມຕົ້ນ Xetel Share ໃຊ້ອິນເຕີເຟສເຄືອຂ່າຍທັງໝົດທີ່ມີ. ທ່ານສາມາດຍົກເວັ້ນເຄືອຂ່າຍທີ່ບໍ່ຕ້ອງການໄດ້ຢູ່ນີ້. ທ່ານຕ້ອງເລີ່ມເຊີບເວີໃໝ່ເພື່ອນຳໃຊ້ການປ່ຽນແປງ.';
  @override
...
class _Translations$receiveOptionsPage$lo extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(ໂຟລເດີ Xetel Share)';
  @override
...
class _Translations$webSharePage$lo extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Xetel Share ໃຊ້ໃບຮັບຮອງທີ່ເຊັນດ້ວຍຕົນເອງ. ທ່ານຕ້ອງຍອມຮັບມັນຢູ່ໃນບຣາວເຊີຂອງທ່ານ.';
  @override
...
class _Translations$aboutPage$lo extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'ກ່ຽວກັບ Xetel Share';
  @override
  List<String> get description => [
    'Xetel Share ເປັນແອັບຟຣີແບບໂອເພັນຊອດ ທີ່ໃຫ້ທ່ານແບ່ງປັນໄຟລ໌ ແລະ ຂໍ້ຄວາມກັບອຸປະກອນໃກ້ຄຽງຜ່ານເຄືອຂ່າຍທ້ອງຖິ່ນຂອງທ່ານໄດ້ຢ່າງປອດໄພ ໂດຍບໍ່ຈຳເປັນຕ້ອງມີການເຊື່ອມຕໍ່ອິນເຕີເນັດ.',
...
class _Translations$donationPage$lo extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Xetel Share ຟຣີ, ໂອເພັນຊອດ ແລະ ບໍ່ມີໂຄສະນາ. ຖ້າທ່ານມັກແອັບນີ້ ທ່ານສາມາດສະໜັບສະໜູນການພັດທະນາດ້ວຍການບໍລິຈາກ.';
  @override
...
class _Translations$tray$lo extends Translations$tray$en {
  ...
  @override
  String get close => 'ອອກຈາກ Xetel Share';
  @override
...
class _Translations$settingsTab$general$lo extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'ສະແດງ Xetel Share ໃນເມນູຄລິກຂວາ';
  @override
...
class _Translations$settingsTab$other$lo extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'ສະໜັບສະໜູນ Xetel Share';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$lo extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Xetel Share ບໍ່ສາມາດຄົ້ນຫາອຸປະກອນອື່ນໄດ້ ຫາກບໍ່ໄດ້ຮັບອະນຸຍາດໃຫ້ສະແກນເຄືອຂ່າຍທ້ອງຖິ່ນ. ກະລຸນາອະນຸຍາດສິດນີ້ໃນການຕັ້ງຄ່າ.';
  @override
...
class _Translations$dialogs$sendModeHelp$lo extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'ຜູ້ຮັບທີ່ບໍ່ໄດ້ຕິດຕັ້ງ Xetel Share ສາມາດດາວໂຫຼດໄຟລ໌ທີ່ເລືອກໄດ້ ໂດຍການເປີດລິ້ງໃນບຣາວເຊີ.';
}
