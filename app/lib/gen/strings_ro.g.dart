...
class _Translations$networkInterfacesPage$ro extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'În mod implicit, Xetel Share folosește toate interfețele de rețea disponibile. Poți exclude rețelele nedorite aici. Trebuie să repornești serverul pentru a aplica modificările.';
  @override
...
class _Translations$receiveOptionsPage$ro extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Dosarul Xetel Share)';
  @override
...
class _Translations$webSharePage$ro extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Xetel Share folosește un certificat auto-semnat. Trebuie să-l accepți în browserul tău.';
  @override
...
class _Translations$aboutPage$ro extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Despre Xetel Share';
  @override
  List<String> get description => [
    'Xetel Share este o aplicație gratuită și open-source care îți permite să partajezi în siguranță fișiere și mesaje cu dispozitivele din apropiere prin rețeaua ta locală, fără a avea nevoie de o conexiune la internet.',
...
class _Translations$donationPage$ro extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Xetel Share este gratuit, open-source și fără reclame. Dacă îți place aplicația, poți susține dezvoltarea cu o donație.';
  @override
...
class _Translations$tray$ro extends Translations$tray$en {
  ...
  @override
  String get close => 'Închide Xetel Share';
  @override
...
class _Translations$settingsTab$general$ro extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Afișează Xetel Share în meniul contextual';
  @override
...
class _Translations$settingsTab$other$ro extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Susține Xetel Share';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ro extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Xetel Share nu poate găsi alte dispozitive fără permisiunea de a scana rețeaua locală. Acordă această permisiune în setări.';
  @override
...
class _Translations$dialogs$sendModeHelp$ro extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Destinatarii care nu au Xetel Share instalat pot descărca fișierele selectate prin deschiderea linkului în browserul lor.';
}
