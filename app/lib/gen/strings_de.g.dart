...
class _Translations$networkInterfacesPage$de extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Standardmäßig verwendet Xetel Share alle verfügbaren Netzwerkschnittstellen. Hier können Sie unerwünschte Netzwerke ausschließen. Sie müssen den Server neu starten, um die Änderungen zu übernehmen.';
  @override
...
class _Translations$receiveOptionsPage$de extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Xetel Share-Ordner)';
  @override
...
class _Translations$webSharePage$de extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Xetel Share verwendet ein selbstsigniertes Zertifikat. Du musst es im Browser akzeptieren.';
  @override
...
class _Translations$aboutPage$de extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Über Xetel Share';
  @override
  List<String> get description => [
    'Xetel Share ist eine kostenlose Open-Source-App, mit der du Dateien und Nachrichten sicher über dein lokales Netzwerk mit Geräten in der Nähe teilen kannst, ohne dass eine Internetverbindung erforderlich ist.',
...
class _Translations$donationPage$de extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Xetel Share ist kostenlos, quelloffen und frei von Werbung. Wenn dir diese App gefällt, kannst du die Entwicklung mit einer Spende unterstützen.';
  @override
...
class _Translations$tray$de extends Translations$tray$en {
  ...
  @override
  String get close => 'Xetel Share beenden';
  @override
...
class _Translations$settingsTab$general$de extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Xetel Share im Kontextmenü anzeigen';
  @override
...
class _Translations$settingsTab$other$de extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Xetel Share unterstützen';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$de extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Xetel Share kann nicht auf das lokale Netzwerk zugreifen. Bitte erlaube Xetel Share den Zugriff auf das lokale Netzwerk in den Einstellungen.';
  @override
...
class _Translations$dialogs$sendModeHelp$de extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Empfänger, die Xetel Share nicht installiert haben, können die ausgewählten Dateien herunterladen, in dem sie den Link im Browser öffnen.';
}
